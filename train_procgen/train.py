...
def main():
    ...
    for i_trial in range(num_trials):
        ...
        num_levels = 1
        disc_coeff = 0.
        LOG_DIR = "/home/josh/w_disc_again" + dist_mode + "/" + env_name + "_disc_coeff_" + str(disc_coeff) + "_num_levels_" + str(num_levels) + "_nsteps_" + str(nsteps) + "_num_frames_" + str(num_frames) + "_num_test_levels_" + str(num_test_levels)
